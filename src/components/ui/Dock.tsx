...
/*************  ✨ Windsurf Command ⭐  *************/
/**
 * A wrapper for an icon to be used in DockItem.
 * It ensures the icon is centered and has a default size.
 * @param {React.ReactNode} children - The icon to be rendered.
 * @param {string} [className] - Additional CSS classes to be applied.
 * @returns {React.ReactElement}
 */
/*******  abded88b-db1a-4532-bed3-c77e8ba09e51  *******/function DockIcon({ children, className = '' }: DockIconProps) {
